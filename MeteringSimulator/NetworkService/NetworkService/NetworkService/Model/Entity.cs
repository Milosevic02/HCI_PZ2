...
{
    public enum Type { Cable_Sensor, Digital_Manometer, All }
    public class Entity : BindableBase
    {
        ...
        public Entity(int id, string name, Type type, List<double> value)
        {
            ...
            if(_type == Type.Cable_Sensor)
            {
                Image = "C:\\Users\\milos\\Documents\\Faculty\\6. Semestar\\HCI\\Pokusaj2\\NetworkService\\NetworkService\\NetworkService\\NetworkService\\Images\\CableSensor.jpg";
            }
            else
            {
                Image = "C:\\Users\\milos\\Documents\\Faculty\\6. Semestar\\HCI\\Pokusaj2\\NetworkService\\NetworkService\\NetworkService\\NetworkService\\Images\\DigitalManometer.jpg";
            }
        }
