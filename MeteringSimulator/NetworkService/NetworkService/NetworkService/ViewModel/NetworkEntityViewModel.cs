...
namespace NetworkService.ViewModel
{
    public class NetworkEntityViewModel : BindableBase
    {
        ...
        public bool IsLowerChecked { get { return _isLowerChecked; } set { if (_isLowerChecked != value) { _isLowerChecked = value; OnPropertyChanged(nameof(IsLowerChecked)); } } }
        public bool IsEqualsChecked { get { return _isEqualsChecked; } set { if (_isEqualsChecked != value) { _isEqualsChecked = value; OnPropertyChanged(nameof(IsEqualsChecked)); } } }
        public bool IsHigherChecked { get { return _isHigherChecked; } set { if (_isHigherChecked != value) { _isHigherChecked = value; OnPropertyChanged(nameof(IsHigherChecked)); } } }
